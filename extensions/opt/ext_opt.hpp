...
//   removes unreachable blocks, compacts block IDs/targets, and merges an
//   unconditional-jump successor when it has exactly one predecessor. Runs
//   these transformations to a fixpoint.
