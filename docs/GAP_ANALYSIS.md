...
| Expose scripting API bindings like AngelScript | ✓ v1 floor | `BindingBuilder` + `NativeSig`; fluent type/engine builders deferred (`BINDING_API.md`) |
...
| `switch` | ✓ v1 (added this pass) | `COMPILER_PIPELINE.md` Section 2, `CODEGEN_SPEC.md` Section 12 |
...
| `defer` | ✓ v1 (added this pass) | `CODEGEN_SPEC.md` Section 13, `COMPILER_PIPELINE.md` Section 6 |
...
- **`switch`** - `COMPILER_PIPELINE.md` Section 2, `CODEGEN_SPEC.md` Section 12
...
- **String interpolation `f"..."`** - `TYPE_SYSTEM.md` Section 11 and
  `COMPILER_PIPELINE.md` Section 6. Parser sentinel
